...
function numerosEsquerda(arrNumbers)
{
	var arrayNumerosEsquerda = [];
	var indexEsquerda = 0;
	...
	for(let i = 0; i < arrNumbers.length; i++)
	{
		if(arrNumbers[i] == 9)
		{
			var contadorEsquerda = 7;
			var posicaoEsquerda = i;
			var numerosEncontradoEsquerda = "";
			
			while(contadorEsquerda > 0)
			{
				if(arrNumbers[posicaoEsquerda] == 0)
				{
					break;
				}

				numerosEncontradoEsquerda += arrNumbers[posicaoEsquerda];
				contadorEsquerda--;
				posicaoEsquerda--;
			}

			arrayNumerosEsquerda[indexEsquerda] = numerosEncontradoEsquerda;
			indexEsquerda++;
			contadorEsquerda--
		}
	...
	return arrayNumerosEsquerda;
}
function numerosDireita(arrNumbers)
{
    var arrayNumerosDireita = [];
    var indexDireita = 0;
    ...
    for(let i = 0; i < arrNumbers.length; i++)
    {
        ...
        if(arrNumbers[i] == 9)
        {
            ...
            var posicaoDireita = i;
            var numerosEncontradoDireita= "";
        
            while(contadorDireita < 7)
            { 
                if(arrNumbers[posicaoDireita] == 0)
                {
                    break
                }    
            
                numerosEncontradoDireita += arrNumbers[posicaoDireita];
                contadorDireita++; 
                posicaoDireita++; 
            }
            
            arrayNumerosDireita[indexDireita] = numerosEncontradoDireita;
            indexDireita++;
            contadorDireita++;
        }
    }

    return arrayNumerosDireita;
}

function mult(arrNumbers)
{
	var arr = arrNumbers.split("");
...
function maxSequence(arrNumbers)
{
	var direita = numerosDireita(arrNumbers);
	var esquerda = numerosEsquerda(arrNumbers);
	var arrD = [];
	for(let i = 0; i < direita.length; i++)
	{

		arrD[i] = mult(direita[i]);
	}

	return arrD;
}

function maxProduto(arrNumbers)
{
	var arr = arrNumbers[0];
	var contador = 0;
	var length = arrNumbers.length;

	while(length--)
	{
		if(arr < arrNumbers[contador])
		{
			arr = arrNumbers[contador];
		}
		contador++;
	}
...
var valor = maxSequence(arrNumbers);

console.log(maxProduto(valor))
